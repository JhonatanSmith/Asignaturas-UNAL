function  [lista, err, k, y] = newtondiff (f, p0, delta, epsilon, max1)
%%% modificacion de newton.m por Javier Adolfo Duque L.
%%%% no requiere calculo externo de la derivada
