...
$$F_0=\frac{(SSE(MR)-SSE(MF))/2}{MSE(MF)}$$ $$=\frac{(SSE(X_1,X_2,X_3)-SSE(X_1,X_2,X_3,X_4))/(n-4)-(n-5)}{MSE(X_1,X_2,X_3,X_4X_5,X_6,X_7,X_8))}$$$$=\frac{SSR(X_1,X_2,X_3,X_4,X_5,X_6,X_7,X_8|X_3,X_8)/2}{MSE(X_1,X_2,X_3,X_4)}\sim f_2,_{45}\space bajo\space H_0$$
