...
#INTERVALOS DE CONFIANZA ASINT?TICOS PARA LAS RA?CES CUADRADAS DE LAS VARIANZAS Y MEDIA GLOBAL
#s?lo son buenas aproximaciones con grados de libertad mayores a 45, en cada componente de varianza!!
confint(diseno)
...
#GR?FICO DE RESIDUOS INTERNAMENTE ESTUDENTIZADOS VS. VALORES AJUSTADOS
...
#GR?FICO DE RESIDUOS VS. NIVELES FACTOR FARDO
...
qqnorm(res.estudent,main="Gr?fico probabilidad normal\nsobre residuos internamente estudentizados")
...
qqnorm(medias.fardos.estand,main="Gr?fico de probabilidad normal\npara los efectos")
