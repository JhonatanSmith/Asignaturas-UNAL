...
train<-sample (1:392 ,floor(392*porc)) # índice del conjunto de entrenamiento con 196 datos

ese floor se utiliza para asegurar que la muestra seleccionada por la 
proporcion de datos seleccionada tenga sentido.
...
De aqui, estoy graficando con normalidad en la base de datos los valores
de la vble de interes. En Azul, entrenamiento, en rojo, prueba.
...
# Calculemos el MSE:
attach (Auto)
mean((mpg-predict(lm.fit, Auto))[-train]^2) # Calculando el MSE
...
El polinomio de grado 2 dio igual que el de grado 3, siendo de 16. algo y por 
principio de parsimonia, se escoge grado 2
